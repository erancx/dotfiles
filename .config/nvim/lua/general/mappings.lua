...
api.nvim_set_keymap("x", "<Up>", "<Nop>", { noremap = true })
api.nvim_set_keymap("x", "<Down>", "<Nop>", { noremap = true })
api.nvim_set_keymap("x", "<Left>", "<Nop>", { noremap = true })
api.nvim_set_keymap("x", "<Right>", "<Nop>", { noremap = true })
