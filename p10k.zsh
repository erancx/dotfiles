# Generated by Powerlevel10k configuration wizard on 2020-12-06 at 19:34 IST.
...
() {
  ...
  function my_git_formatter() {
    ...
    res+="${clean}%20F${where//\%/%%}${clean}"  # escape %
    ...
    if [[ -n ${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH} ]]; then
      res+="${clean}:${clean}${(V)VCS_STATUS_REMOTE_BRANCH//\%/%%}"  # escape %
    fi
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=9
  ...
  typeset -g POWERLEVEL9K_GCLOUD_BACKGROUND=153
